...
**（一）确定债务处置企业名单。** 地方各级人民政府、各级相关国有资产管理部门应按照处置范围并结合实际情况，定期确定需开展债务处置的"僵尸企业"和去产能企业名单并及时通报相关金融机构和其他债权人。尚未确定过"僵尸企业"和去产能企业债务处置名单的地方各级人民政府、各级相关国有资产管理部门，应在本通知发布后三个月内确定首批名单。要合理安排确定后续处置企业名单，原则上应在 2020 年底前完成全部处置工作。
...
本通知由 11 个部委联合发布，经国务院同意，是供给侧结构性改革背景下处置"僵尸企业"和去产能企业债务的重要政策文件。文件以市场化法治化为基本原则，构建了从名单确定、方案形成到政策保障的全流程债务处置框架。

### 核心要点

1. **处置范围**：涵盖直接债务、统借债务和担保债务三类
2. **处置方式**：破产清算、破产重整、债务重组、兼并重组等分类处置
3. **处置时限**：名单确定后 6 个月内形成重组方案，原则上 2020 年底前完成全部处置
4. **破产程序**：明确破产重整计划草案应在 6 个月（最多延长 3 个月）内形成
