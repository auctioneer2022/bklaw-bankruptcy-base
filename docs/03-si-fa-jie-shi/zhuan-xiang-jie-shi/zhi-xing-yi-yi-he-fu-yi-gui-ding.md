...
category: "司法解释"
tags: ["执行异议", "执行复议", "案外人异议", "执行行为异议", "权利排除"]
...
**文号**：法释〔2015〕10 号
**审议通过**：2014 年 12 月 29 日最高人民法院审判委员会第 1638 次会议
**发布日期**：2015 年 5 月 5 日
**施行日期**：2015 年 5 月 5 日
**修正**：2020 年 12 月 23 日最高人民法院审判委员会第 1823 次会议修正
...
本规定是最高人民法院为规范人民法院办理执行异议和复议案件而制定的重要司法解释，共 32 条，系统规定了执行异议和复议案件的受理、审查、处理程序。该规定确立了执行行为异议与案外人异议的双轨制审查模式，明确了各类异议的审查标准和处理规则，对于保护当事人、利害关系人和案外人的合法权益具有重要意义。
...
| 异议类型 | 法律依据 | 审查标准 | 救济途径 |
|----------|----------|----------|----------|
| 执行行为异议 | 民诉法第 225 条 | 执行行为是否违法 | 向上一级法院申请复议 |
| 案外人异议 | 民诉法第 227 条 | 案外人是否享有排除执行的实体权利 | 提起执行异议之诉 |
...
|----------|----------|
| 已登记不动产 | 不动产登记簿 |
| 未登记建筑物 | 土地使用权登记簿、建设工程规划许可、施工许可等 |
| 已登记特定动产 | 相关管理部门登记 |
| 未登记动产 | 实际占有情况 |
| 银行存款 | 金融机构登记的账户名称 |
| 股权 | 工商登记和企业信用信息公示系统 |
| 其他财产 | 有登记的按登记，无登记的按合同等证据 |

#### 3. 案外人排除执行的典型情形

| 条文 | 适用情形 | 核心要件 |
|------|----------|----------|
| 第二十八条 | 不动产买受人 | 查封前签约、占有、付款、非因自身原因未过户 |
| 第二十九条 | 商品房消费者 | 查封前签约、用于居住、名下无其他住房、付款超 50% |
| 第三十条 | 预告登记权利人 | 已办理受让物权预告登记 |
| 第三十一条 | 承租人 | 查封前签约并占有使用 |
...
| 情形 | 处理方式 |
|------|----------|
| 认定事实清楚、适用法律正确 | 驳回复议申请，维持异议裁定 |
| 认定事实错误或适用法律错误 | 撤销或变更异议裁定 |
| 基本事实不清、证据不足 | 发回重新审查或查清事实后裁定 |
| 遗漏异议请求或严重违反法定程序 | 发回重新审查 |
| 错误适用第 225 条而非第 227 条 | 发回重新作出裁定 |

### 三、与破产程序的关联

本规定与破产程序存在以下关联：

1. **执行行为异议**：破产程序中，当事人、利害关系人对破产财产保全、变价、分配等执行行为可以提出异议
2. **案外人异议**：案外人对破产财产主张权利的，可以提出排除执行异议
3. **权利判断标准**：破产程序中确定财产权属时，可参照本规定第二十五条的标准
...
| 异议类型 | 提出期限 |
|----------|----------|
| 执行行为异议 | 执行程序终结之前（对终结执行措施除外） |
| 案外人异议 | 执行标的执行终结之前；标的由当事人受让的，执行程序终结之前 |

#### 不予受理的情形（第十五条）

- 对同一执行行为，多个异议事由未一并提出，撤回或驳回后再次提出的
- 案外人撤回异议或被驳回后，再次就同一执行标的提出异议的
